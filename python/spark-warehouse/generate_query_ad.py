...
if __name__ == "__main__":
    ...
    with open(ad_input_file, "r") as lines:
        for line in lines:
            ...
            if "category" in entry and "query" in entry and "campaignId" in entry and "queryGroupId" in entry and "keyWords" in entry  and "adId" in entry:
                query = entry["query"].lower()
                campaignId = entry["campaignId"]
                adId = entry["adId"]
                query_group_id = entry["queryGroupId"]
