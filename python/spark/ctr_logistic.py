...
if __name__ == "__main__":
    ...
    data = sc.textFile("/Users/mac/Projects/SearchAds/data/log/ctr_features_small/part*")
    ...
    # Save and load model
    model.save(sc, "/Users/mac/Projects/SearchAds/data/model/ctr_logistic_model")
    # $example off$
